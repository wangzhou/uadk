 ...
 */
struct sched_ctx_region *sample_get_ctx_range(struct wd_comp_arg *arg,
					      struct sched_ctx_region **ctx_map)
{
	return NULL;
}
...
{
	/*
	 * Different mode attention different attribute, we need define the
	 * attribute for the mode
	 */
	return;
}
