...
__u32 sample_poll_policy_rr(struct wd_ctx_config *cfg,
			    struct sched_ctx_region (*region)[Y_BUTT])
{
	int i, j;
	int begin, end;
...
struct sched_operator g_sched_ops[USER_SCHED_BUTT] = {
	{
 ...
 */
int sample_sched_get_size(void)
{
	int size;
